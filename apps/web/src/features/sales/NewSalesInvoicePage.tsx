...
const emptyLine = { itemId: "", warehouseId: "", qty: "1", unitPrice: "", taxGroupId: undefined };
...
export function NewSalesInvoicePage() {
  ...
  const handlePaste = createGridPasteHandler({
    ...
    columns: [
      ...
      { key: "unitPrice", resolve: (text) => text.trim() },
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead className="w-28 border-e border-border">{t("sales.unitPrice")}</TableHead>
                  ...
                  <TableBody>
                    {fields.map((field, index) => {
                      ...
                      return (
                        <TableRow key={field.id} data-testid={`sales-line-${index}`}>
